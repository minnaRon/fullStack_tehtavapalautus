  ...
  describe('When logged in', function() {
    ...
    describe('and blog exists', function() {
      ...
      it('Sorted descending order by amount of likes', function() {
        cy.createBlog({title:'testTitle2Likes', author:'testAuthor', url:'testUrl'})
        cy.contains('testTitle2Likes')
          .contains('view')
          .click()
          .parent()
          .contains('like').as('likeButton2')
        cy.get('@likeButton2').click()
        cy.wait(1000)
        cy.get('@likeButton2').click()
        cy.get('@likeButton2').parent().contains('likes 2')

        cy.createBlog({title:'testTitle4Likes', author:'testAuthor', url:'testUrl'})
        cy.contains('testTitle4Likes')
          .contains('view')
          .click()
          .parent()
          .contains('like').as('likeButton4')
        ...
        cy.createBlog({title:'testTitle3Likes', author:'testAuthor', url:'testUrl'})
        cy.contains('testTitle3Likes')
          .contains('view')
          .click()
          .parent()
          .contains('like').as('likeButton3')
